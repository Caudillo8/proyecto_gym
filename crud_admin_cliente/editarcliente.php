...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <form action="sp_editarcliente.php" method="POST" onsubmit="return validarFormulario()"> <!-- onsubmit Utiliza el script en caso de que haya errores -->>
                <div class="col-6 mx-auto">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="sexo">
                            <option value="Masculino" <?php if ($sexo == "Masculino")
                                echo "selected"; ?>>Masculino
                            </option>
                            <option value="Femenino" <?php if ($sexo == "Femenino")
                                echo "selected"; ?>>Femenino</option>
                            <option value="No binario" <?php if ($sexo == "No binario")
                                echo "selected"; ?>>No binario
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <a class="btn btn-outline-primary my-1" href="crud_admin_cliente.php">Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
