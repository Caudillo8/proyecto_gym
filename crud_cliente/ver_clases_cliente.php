            ...
            <div class="col my-2">
                <div class="table-responsive">
                    <table class="table table-responsive">
                        ...
                        <?php
                        $select = "SELECT DISTINCT c.id, c.fecha, c.inicio, c.fin, c.fk_actividades, a.nombre, c.cupos, c.comentarios FROM clases c JOIN actividades a ON c.fk_actividades = a.id JOIN reservas r ON r.fk_clase = c.id WHERE r.fk_cliente = $idIngresoCliente AND c.fecha >= CURDATE() ORDER BY c.fecha DESC;";
                        $query = mysqli_query($conexion, $select);
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <a class="btn btn-danger m-1"
                                        href="ver_clases_cliente_cancelar.php?idCancelarClase=<?php echo $resultado['0'] ?>">
                                        Cancelar cupo
                                    </a>
                                </td>
                            </tr>
