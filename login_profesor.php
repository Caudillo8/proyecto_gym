...
if (isset($_POST['ingresar'])) {
    ...
    if ($fila) {
        ...
        $_SESSION['usuario'] = $usuario; // Guarda el nombre de usuario en la sesión
            echo '<script>alert("Bienvenido ' . $usuario . '!"); window.location.href = "crud_profesor/abm_profesor.php";</script>';
    } 
    else {
        echo '<script>alert("Credenciales incorrectas."); window.location.href = "login_profesor.php";</script>';
    }
}
?>
                        ...
                        <div class="card-body text-white" style="background-color: #000;">
                            <form action="" method="post" onsubmit="return ValidarLogin()">
                                <div class="my-3">
                                    ...
                                    <input <?php if (isset($_SESSION['ingresoProfesor']))
                                        echo "disabled" ?>
                                    ...
                                    <div class="my-3 d-flex flex-column align-items-center justify-content-center">
                                        <input <?php if (isset($_SESSION['ingresoProfesor']))
                                        echo 'style="visibility:hidden"' ?> class="btn btn-primary" type="submit"
