                ...
                <div class="col-lg-4 mx-auto">
                    <div class="card border-white" style="background-color: #000;">
                        <div class="card-header text-white text-center">
                            <?php
                            if(isset($_SESSION['ingresoProfesor'])) {
                                echo "YA ESTAS LOGUEADO";
                            } else {
                                echo "Ingreso Profesor";
                            }
                            ?>
                        </div>
                        <div class="card-body text-white" style="background-color: #000;">
                            <form action="" method="post">
                                <div class="my-3">
                                    ...
                                    <input <?php if(isset($_SESSION['ingresoProfesor'])) echo "disabled" ?> class="form-control" type="text" name="usuario">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Contraseña:</label>
                                    <input <?php if(isset($_SESSION['ingresoProfesor'])) echo "disabled" ?> class="form-control" type="password" name="clave">
                                </div>
                                <div class="my-3 d-flex flex-column align-items-center justify-content-center">
                                    <input <?php if(isset($_SESSION['ingresoProfesor'])) echo 'style="visibility:hidden"' ?> class="btn btn-primary" type="submit" name="ingresar" value="Ingresar">
