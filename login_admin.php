                        ...
                        <div class="card-body text-white" style="background-color: #000;">
                            <form action="" method="post" class="login_admin">
                                <div class="my-3">
                                    ...
                                    <input <?php if(isset($_SESSION['ingreso'])) echo "disabled" ?> class="form-control" type="text" name="usuario">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Contraseña:</label>
                                    <input <?php if(isset($_SESSION['ingreso'])) echo "disabled" ?> class="form-control" type="password" name="clave">
                                </div>
                                <div class="my-3 d-flex flex-column align-items-center justify-content-center">
                                    <input <?php if(isset($_SESSION['ingreso'])) echo 'style="visibility:hidden"' ?> class="btn btn-primary" type="submit" name="ingresar" value="Ingresar">
