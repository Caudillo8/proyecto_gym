        ...
        <div class="row align-items-center mx-auto">
            <div class="col-lg">
                <div class="card p-3 my-3 mx-auto" style="max-width: 1000px; background-color:black">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/imagen-inicio.jpg" class="img-fluid rounded-start" alt="Entrenamiento Kickboxing">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h1 class="card-title text-white">Bienvenido a NombreSistema!</h1>
                          <p class="card-text text-white">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nisi laborum magni, quasi dolorum optio, nulla dolorem illum eaque, eligendi deserunt porro alias. Fugiat consectetur culpa ut sapiente, distinctio necessitatibus illo?</p>
                          <p class="card-text text-white">No sabés por donde arrancar? <a href="#" style="color: #4ACEF0">Creá tu cuenta!</a></p>
                        </div>
                      </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 mx-auto">
                <div class="card text-bg-info my-3" style="max-width: 18rem;">
                    <div class="card-header">Agenda</div>
                    <div class="card-body">
                      <h5 class="card-title">Ya formás parte de NombreSistema?</h5>
                      <p class="card-text">Si ya estás registrado y querés reservar una clase, tocá en Ver agenda.</p>
                      <a class="btn btn-primary">Ver agenda</a>
                    </div>
                </div>
            </div>
        </div>
