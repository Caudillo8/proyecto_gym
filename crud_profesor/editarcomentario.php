...
<body>
    ...
    <div class="container py-5" style="min-height: 700px">
        <div class="row">
            <div class="col">
                <form method="POST" action="sp_editarcomentario.php">
                    <div class="mb-3">
                        <label class="form-label" style="visibility:hidden">Id:</label>
                        <input class="form-control" type="text" name="idClase" value="<?= $idClase ?>" id=""
                            style="visibility:hidden">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Comentario:</label>
                        <textarea class="form-control" name="comentarios" style="resize: none;" maxlength="50" rows="10"
                            cols="50"><?= $comentarios ?></textarea>
                    </div>
                    <div class="mb-3">
                        <input class="btn btn-primary" type="submit" value="Modificar">
                        <a class="btn btn-outline-primary" href="abm_profesor.php">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
